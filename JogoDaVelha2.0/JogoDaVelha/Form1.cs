...
namespace JogoDaVelha
{
    public partial class Form1 : Form
    {
        ...
        private void wins()
        {
            //Se a variavel p1 for igual a 1 a vitoria será do jogador 1,s
            //se não for a vitoria será do jogador 2 
            if (Global.p1 == 1)
            {
                Global.player1_vitorias++;
                lblresultado_p1.Text = Convert.ToString(Global.player1_vitorias);
                MessageBox.Show("Jogador 1 venceu!");
                //Global.button_disable = true;
            }
            ...
            else if (Global.p1 == 2)
            {
                ...
                lblresultado_p2.Text = Convert.ToString(Global.player2_vitorias);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (Global.vezJogador == false && Global.LacunaA == 0)
            {
            ...
            {
                Global.vezJogador = true; Global.button_disable = false; Global.LacunaA = 0;
                button1.Text = "O";
                Global.LacunaA = 2;
                Global.rodadas++;
                checarVencedor();
        ...
        {
            if (Global.vezJogador == false && Global.LacunaB == 0)
            {
                Global.button_disable = false;
                button2.Text = "X";
                Global.LacunaB = 1;
            ...
            {
                Global.vezJogador = true; Global.button_disable = false; Global.LacunaB = 0;
                button2.Text = "O";
                Global.LacunaB = 2;
                Global.rodadas++;
                checarVencedor();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            else if (Global.vezJogador == true && Global.button_disable == false && Global.LacunaB == 0)
            {
                button5.Text = "O";
                Global.LacunaE = 2;
                Global.rodadas++;
